---
name: guide
description: "Index of the user-invoked standalone skills — what each one does and when to reach for it."
...
An index of the plugin's user-invoked standalone skills. Each entry links to the skill itself — read that for how it works.
...
| [`/feature:sync`](../sync/SKILL.md) | Reconciles in-review tickets with their GitHub PR state — promotes merged PRs' tickets to done, flags closed-unmerged ones | You want merged reviews finalized in one pass; it never builds a ticket, opens a PR, or reverts anything |
