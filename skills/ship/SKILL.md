...
- `$1 …` = one or more IDs to ship, in the order given — solo ticket IDs or an epic ID (e.g. `FP-14 FP-15`). The run shape — **epic**, **solo**, or **multi-solo** — and what it means for branches and PRs are classified from the resolved tickets in SETUP step 1 (branch strategy in step 3).
